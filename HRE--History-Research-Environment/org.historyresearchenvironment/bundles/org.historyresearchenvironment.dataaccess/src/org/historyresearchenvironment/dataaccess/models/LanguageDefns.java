...
public class LanguageDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "LANGUAGE_DEFN_PID, " + "LANGUAGE_CODE, " + "LANGUAGE_NAME, " + "IS_GUI_LANG, " + "IS_DATA_LANG, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.LANGUAGE_DEFNS WHERE LANGUAGE_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "LANGUAGE_DEFN_PID, " + "LANGUAGE_CODE, " + "LANGUAGE_NAME, " + "IS_GUI_LANG, " + "IS_DATA_LANG, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW FROM PUBLIC.LANGUAGE_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.LANGUAGE_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "LANGUAGE_DEFN_PID, " + "LANGUAGE_CODE, " + "LANGUAGE_NAME, " + "IS_GUI_LANG, "
			+ "IS_DATA_LANG, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.LANGUAGE_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "LANGUAGE_CODE = ?, " + "LANGUAGE_NAME = ?, " + "IS_GUI_LANG = ?, "
			+ "IS_DATA_LANG = ?, " + "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, "
