...
public class SubsetMixDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSET_MIX_DEFN_PID, " + "SUBSET_PID, " + "USE_ORDER, " + "REFER1_PID, "
			+ "REFER2_PID FROM PUBLIC.SUBSET_MIX_DEFNS WHERE SUBSET_MIX_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSET_MIX_DEFN_PID, " + "SUBSET_PID, " + "USE_ORDER, " + "REFER1_PID, "
			+ "REFER2_PID FROM PUBLIC.SUBSET_MIX_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.SUBSET_MIX_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SUBSET_MIX_DEFN_PID, " + "SUBSET_PID, " + "USE_ORDER, " + "REFER1_PID, "
			+ "REFER2_PID) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SUBSET_MIX_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
	 ...
	 *
	 * @param SubsetMixDefnPid
	 *            Contents of the SUBSET_MIX_DEFN_PID column
	 */
