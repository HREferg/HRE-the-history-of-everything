...
public class LanguageUses extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "LANGUAGE_USE_PID, " + "GUI_LANGUAGE, " + "DATA1_LANGUAGE, " + "DATA2_LANGUAGE, " + "REPORT_LANGUAGE, "
			+ "DFLT_LANGUAGE FROM PUBLIC.LANGUAGE_USES WHERE LANGUAGE_USE_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "LANGUAGE_USE_PID, " + "GUI_LANGUAGE, " + "DATA1_LANGUAGE, " + "DATA2_LANGUAGE, " + "REPORT_LANGUAGE, "
			+ "DFLT_LANGUAGE FROM PUBLIC.LANGUAGE_USES";

	private static final String INSERT = "INSERT INTO PUBLIC.LANGUAGE_USES( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "LANGUAGE_USE_PID, " + "GUI_LANGUAGE, " + "DATA1_LANGUAGE, " + "DATA2_LANGUAGE, "
			+ "REPORT_LANGUAGE, " + "DFLT_LANGUAGE) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?)";

	private static final String UPDATE = "UPDATE PUBLIC.LANGUAGE_USESSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "GUI_LANGUAGE = ?, " + "DATA1_LANGUAGE = ?, " + "DATA2_LANGUAGE = ?, "
			+ "REPORT_LANGUAGE = ?, " + "DFLT_LANGUAGE = ? WHERE LANGUAGE_USE_PID = ?";
