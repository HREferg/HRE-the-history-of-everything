...
"DISPLAY_ORDER, " +
"IS_DEFAULT, " +
"SHOW FROM PUBLIC.SUBSET_DEFNS WHERE SUBSET_DEFN_PID = ?";
...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.SUBSET_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.SUBSET_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"SUBSET_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.SUBSET_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public SubsetDefns get(int key) throws SQLException {
model = new SubsetDefns();
...
*
* @param SubsetDefnPid Contents of the SUBSET_DEFN_PID column
*/
...
*
* @param SubsetTypeKey Contents of the SUBSET_TYPE_KEY column
*/
...
* Set the Size field
*
* @param Size Contents of the SIZE column
*/
...
*
* @param StackIndex Contents of the STACK_INDEX column
*/
