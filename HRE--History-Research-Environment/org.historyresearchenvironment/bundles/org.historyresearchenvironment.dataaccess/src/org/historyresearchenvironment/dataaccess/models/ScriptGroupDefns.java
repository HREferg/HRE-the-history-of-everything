...
public class ScriptGroupDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SCRIPT_GROUP_DEFN_PID, " + "ACTION_TYPE_KEY, " + "INPUT_FOCUS_TYPE_KEY, " + "INPUT_SUB_TYPE_KEY, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.SCRIPT_GROUP_DEFNS WHERE SCRIPT_GROUP_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SCRIPT_GROUP_DEFN_PID, " + "ACTION_TYPE_KEY, " + "INPUT_FOCUS_TYPE_KEY, " + "INPUT_SUB_TYPE_KEY, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW FROM PUBLIC.SCRIPT_GROUP_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.SCRIPT_GROUP_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SCRIPT_GROUP_DEFN_PID, " + "ACTION_TYPE_KEY, " + "INPUT_FOCUS_TYPE_KEY, "
			+ "INPUT_SUB_TYPE_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SCRIPT_GROUP_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "ACTION_TYPE_KEY = ?, " + "INPUT_FOCUS_TYPE_KEY = ?, " + "INPUT_SUB_TYPE_KEY = ?, "
			+ "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, "
