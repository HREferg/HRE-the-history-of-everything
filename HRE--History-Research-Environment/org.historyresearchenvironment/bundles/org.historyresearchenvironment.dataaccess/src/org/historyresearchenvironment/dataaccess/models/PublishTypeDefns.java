...
public class PublishTypeDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PUBLISH_TYPE_DEFN_PID, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.PUBLISH_TYPE_DEFNS WHERE PUBLISH_TYPE_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PUBLISH_TYPE_DEFN_PID, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.PUBLISH_TYPE_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.PUBLISH_TYPE_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "PUBLISH_TYPE_DEFN_PID, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.PUBLISH_TYPE_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
	...
	/**
	 * Get the PublishTypeDefnPid field.
	 *
	 * @return Contents of the PUBLISH_TYPE_DEFN_PID column
	 */
	...
	/**
	 * Set the PublishTypeDefnPid field
	 *
	 * @param PublishTypeDefnPid
	 *            Contents of the PUBLISH_TYPE_DEFN_PID column
	 */
