...
@Override
public SchemaDefns get(int key) throws SQLException {
model = new SchemaDefns();
...
*
* @param SchemaDefnPid Contents of the SCHEMA_DEFN_PID column
*/
...
*
* @param MainPckgKey Contents of the MAIN_PCKG_KEY column
*/
