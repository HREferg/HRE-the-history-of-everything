...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.NAMED_MEMO_TYPE_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.NAMED_MEMO_TYPE_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"NAMED_MEMO_TYPE_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.NAMED_MEMO_TYPE_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public NamedMemoTypeDefns get(int key) throws SQLException {
model = new NamedMemoTypeDefns();
...
*
* @param NamedMemoTypeDefnPid Contents of the NAMED_MEMO_TYPE_DEFN_PID column
*/
...
*
* @param ParentTagTypePid Contents of the PARENT_TAG_TYPE_PID column
*/
