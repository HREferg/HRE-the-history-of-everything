...
@Override
public SubstnParamNames get(int key) throws SQLException {
model = new SubstnParamNames();
...
*
* @param SubstnParamNamePid Contents of the SUBSTN_PARAM_NAME_PID column
*/
...
*
* @param MustBeEntered Contents of the MUST_BE_ENTERED column
*/
...
*
* @param DefltValue Contents of the DEFLT_VALUE column
*/
