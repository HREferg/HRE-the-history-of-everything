...
public class SubstnOtherAliases extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSTN_OTHER_ALIAS_PID, " + "IS_SYSTEM, " + "IS_TEXT_LAYOUT_RELATED, " + "IS_TEXT_STYLE_RELATED, "
			+ "TOP_STEP_KEY, " + "REQUESTER_TYPE_KEY, " + "REQUESTER_SUB_TYPE_KEY, " + "OUTPUT_TYPE_KEY, "
			+ "OUTPUT_SUB_TYPE_KEY, " + "PARAM_LIST_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.SUBSTN_OTHER_ALIASES( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SUBSTN_OTHER_ALIAS_PID, " + "IS_SYSTEM, " + "IS_TEXT_LAYOUT_RELATED, "
			+ "IS_TEXT_STYLE_RELATED, " + "TOP_STEP_KEY, " + "REQUESTER_TYPE_KEY, " + "REQUESTER_SUB_TYPE_KEY, "
			+ "OUTPUT_TYPE_KEY, " + "OUTPUT_SUB_TYPE_KEY, " + "PARAM_LIST_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, "
			+ "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SUBSTN_OTHER_ALIASESSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "IS_TEXT_LAYOUT_RELATED = ?, " + "IS_TEXT_STYLE_RELATED = ?, "
			+ "TOP_STEP_KEY = ?, " + "REQUESTER_TYPE_KEY = ?, " + "REQUESTER_SUB_TYPE_KEY = ?, "
			+ "OUTPUT_TYPE_KEY = ?, " + "OUTPUT_SUB_TYPE_KEY = ?, " + "PARAM_LIST_KEY = ?, " + "REMINDER_KEY = ?, "
			+ "DISPLAY_ORDER = ?, " + "SHOW = ? WHERE SUBSTN_OTHER_ALIAS_PID = ?";
