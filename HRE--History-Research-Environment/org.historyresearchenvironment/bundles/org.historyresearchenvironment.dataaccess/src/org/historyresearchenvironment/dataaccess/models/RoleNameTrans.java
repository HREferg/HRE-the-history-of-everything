...
private static final String INSERT = "INSERT INTO PUBLIC.ROLE_NAME_TRANS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"ROLE_NAME_TRAN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.ROLE_NAME_TRANSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public RoleNameTrans get(int key) throws SQLException {
model = new RoleNameTrans();
...
*
* @param RoleNameTranPid Contents of the ROLE_NAME_TRAN_PID column
*/
