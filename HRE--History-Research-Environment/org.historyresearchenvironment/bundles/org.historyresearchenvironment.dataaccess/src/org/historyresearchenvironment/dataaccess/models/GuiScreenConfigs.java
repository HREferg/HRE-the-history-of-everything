...
private static final String INSERT = "INSERT INTO PUBLIC.GUI_SCREEN_CONFIGS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"GUI_SCREEN_CONFIG_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.GUI_SCREEN_CONFIGSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"PLUGIN_KEY = ?, " + 
...
"DISPLAY_ORDER = ?, " + 
"IS_DEFAULT = ?, " + 
"SHOW = ? WHERE GUI_SCREEN_CONFIG_PID = ?";
...
@Override
public GuiScreenConfigs get(int key) throws SQLException {
model = new GuiScreenConfigs();
...
*
* @param GuiScreenConfigPid Contents of the GUI_SCREEN_CONFIG_PID column
*/
