...
"DISPLAY_ORDER, " +
"IS_DEFAULT, " +
"SHOW FROM PUBLIC.MEMO_SET_DEFNS WHERE MEMO_SET_DEFN_PID = ?";
...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.MEMO_SET_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.MEMO_SET_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"MEMO_SET_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.MEMO_SET_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public MemoSetDefns get(int key) throws SQLException {
model = new MemoSetDefns();
...
*
* @param MemoSetDefnPid Contents of the MEMO_SET_DEFN_PID column
*/
