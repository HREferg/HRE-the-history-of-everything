...
public class SubsetBioNetworkDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSET_BIO_NETWORK_DEFN_PID, " + "SUBSET_PID, " + "USE_ORDER, " + "BIO_PID, " + "PARENT_SET_PID, "
			+ "THIS_GENERATION, " + "MIN_GENERATION, " + "IS_ANCESTRAL_LINK, " + "IS_VIA_FEMALE_ANCESTOR, "
			+ "KIN_CODE, "
			+ "COMMON_PARENT_SET_PID FROM PUBLIC.SUBSET_BIO_NETWORK_DEFNS WHERE SUBSET_BIO_NETWORK_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSET_BIO_NETWORK_DEFN_PID, " + "SUBSET_PID, " + "USE_ORDER, " + "BIO_PID, " + "PARENT_SET_PID, "
			+ "THIS_GENERATION, " + "MIN_GENERATION, " + "IS_ANCESTRAL_LINK, " + "IS_VIA_FEMALE_ANCESTOR, "
			+ "KIN_CODE, " + "COMMON_PARENT_SET_PID FROM PUBLIC.SUBSET_BIO_NETWORK_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.SUBSET_BIO_NETWORK_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SUBSET_BIO_NETWORK_DEFN_PID, " + "SUBSET_PID, " + "USE_ORDER, " + "BIO_PID, "
			+ "PARENT_SET_PID, " + "THIS_GENERATION, " + "MIN_GENERATION, " + "IS_ANCESTRAL_LINK, "
			+ "IS_VIA_FEMALE_ANCESTOR, " + "KIN_CODE, " + "COMMON_PARENT_SET_PID) VALUES (?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SUBSET_BIO_NETWORK_DEFNSSET " + "RECORD_NUM = ?, "
			+ "SET_KEY = ?, " + "COMMIT_PID = ?, " + "SUBSET_PID = ?, " + "USE_ORDER = ?, " + "BIO_PID = ?, "
			+ "PARENT_SET_PID = ?, " + "THIS_GENERATION = ?, " + "MIN_GENERATION = ?, " + "IS_ANCESTRAL_LINK = ?, "
			+ "IS_VIA_FEMALE_ANCESTOR = ?, " + "KIN_CODE = ?, "
