...
public class OccasnAssocs extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "OCCASN_ASSOC_PID, " + "IS_SYSTEM, " + "OCCASN_ASSOC_TAG_KEY, " + "OCCASN_SUB_TYPE_KEY, " + "OCCASN_PID, "
			+ "ASSOC_TYPE_KEY, " + "ASSOC_SUB_TYPE_KEY, " + "ASSOC_TYPE_PID, " + "ASSOC_NAME_USED_PID, " + "THEME_KEY, "
			+ "LOCAL_SENTCE_SET_PID, " + "SENTCE_STYLE_KEY, " + "MEMO_SET_PID, " + "DISPLAY_ORDER, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.OCCASN_ASSOCS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "OCCASN_ASSOC_PID, " + "IS_SYSTEM, " + "OCCASN_ASSOC_TAG_KEY, " + "OCCASN_SUB_TYPE_KEY, "
			+ "OCCASN_PID, " + "ASSOC_TYPE_KEY, " + "ASSOC_SUB_TYPE_KEY, " + "ASSOC_TYPE_PID, "
			+ "ASSOC_NAME_USED_PID, " + "THEME_KEY, " + "LOCAL_SENTCE_SET_PID, " + "SENTCE_STYLE_KEY, "
			+ "MEMO_SET_PID, " + "DISPLAY_ORDER, " + "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.OCCASN_ASSOCSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "OCCASN_ASSOC_TAG_KEY = ?, " + "OCCASN_SUB_TYPE_KEY = ?, "
			+ "OCCASN_PID = ?, " + "ASSOC_TYPE_KEY = ?, " + "ASSOC_SUB_TYPE_KEY = ?, " + "ASSOC_TYPE_PID = ?, "
			+ "ASSOC_NAME_USED_PID = ?, " + "THEME_KEY = ?, " + "LOCAL_SENTCE_SET_PID = ?, " + "SENTCE_STYLE_KEY = ?, "
			+ "MEMO_SET_PID = ?, " + "DISPLAY_ORDER = ?, " + "SHOW = ? WHERE OCCASN_ASSOC_PID = ?";
