...
@Override
public SubsetTypeDefns get(int key) throws SQLException {
model = new SubsetTypeDefns();
...
*
* @param SubsetTypeDefnPid Contents of the SUBSET_TYPE_DEFN_PID column
*/
...
*
* @param Focus1TypeKey Contents of the FOCUS1_TYPE_KEY column
*/
...
*
* @param Focus1SubTypeKey Contents of the FOCUS1_SUB_TYPE_KEY column
*/
...
* Set the IsAll field
*
* @param IsAll Contents of the IS_ALL column
*/
...
*
* @param IsSingle Contents of the IS_SINGLE column
*/
...
*
* @param Focus2TypeKey Contents of the FOCUS2_TYPE_KEY column
*/
...
*
* @param Focus2SubTypeKey Contents of the FOCUS2_SUB_TYPE_KEY column
*/
...
*
* @param IsMixed Contents of the IS_MIXED column
*/
...
*
* @param IsBioNetwork Contents of the IS_BIO_NETWORK column
*/
...
*
* @param BioFocusPid Contents of the BIO_FOCUS_PID column
*/
...
*
* @param AncestorGens Contents of the ANCESTOR_GENS column
*/
...
*
* @param DescendantGens Contents of the DESCENDANT_GENS column
*/
...
*
* @param ExcludeNonGeneticLinks Contents of the EXCLUDE_NON_GENETIC_LINKS column
*/
...
*
* @param ExcludeMixedSexLinks Contents of the EXCLUDE_MIXED_SEX_LINKS column
*/
...
*
* @param UseBioFlag Contents of the USE_BIO_FLAG column
*/
...
*
* @param BioFlagState Contents of the BIO_FLAG_STATE column
*/
