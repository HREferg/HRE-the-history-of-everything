...
public class NameElmntInputDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "NAME_ELMNT_INPUT_DEFN_PID, " + "IS_SYSTEM, " + "ENTITY_TYPE_KEY, " + "ENTITY_SUB_TYPE_KEY, "
			+ "PARENT_NAME_STYLE_KEY, " + "NAME_ELMNT_TYPE_KEY, " + "DATA_TYPE_KEY, " + "FIELD_RANK_ORDER, "
			+ "VALID_SCRIPT_GROUP_KEY, " + "VALID_SCRIPT_KEY, " + "LEFT_FIELD_ELMNT_KEY, " + "RIGHT_FIELD_ELMNT_KEY, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "IS_DETAIL_ELMNT, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.NAME_ELMNT_INPUT_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "NAME_ELMNT_INPUT_DEFN_PID, " + "IS_SYSTEM, " + "ENTITY_TYPE_KEY, "
			+ "ENTITY_SUB_TYPE_KEY, " + "PARENT_NAME_STYLE_KEY, " + "NAME_ELMNT_TYPE_KEY, " + "DATA_TYPE_KEY, "
			+ "FIELD_RANK_ORDER, " + "VALID_SCRIPT_GROUP_KEY, " + "VALID_SCRIPT_KEY, " + "LEFT_FIELD_ELMNT_KEY, "
			+ "RIGHT_FIELD_ELMNT_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "IS_DETAIL_ELMNT, "
			+ "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.NAME_ELMNT_INPUT_DEFNSSET " + "RECORD_NUM = ?, "
			+ "SET_KEY = ?, " + "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "ENTITY_TYPE_KEY = ?, "
			+ "ENTITY_SUB_TYPE_KEY = ?, " + "PARENT_NAME_STYLE_KEY = ?, " + "NAME_ELMNT_TYPE_KEY = ?, "
			+ "DATA_TYPE_KEY = ?, " + "FIELD_RANK_ORDER = ?, " + "VALID_SCRIPT_GROUP_KEY = ?, "
			+ "VALID_SCRIPT_KEY = ?, " + "LEFT_FIELD_ELMNT_KEY = ?, " + "RIGHT_FIELD_ELMNT_KEY = ?, "
			+ "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, " + "IS_DETAIL_ELMNT = ?, "
