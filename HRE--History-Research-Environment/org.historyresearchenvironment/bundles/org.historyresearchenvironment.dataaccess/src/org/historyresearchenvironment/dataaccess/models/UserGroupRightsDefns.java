...
public class UserGroupRightsDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "USER_GROUP_RIGHTS_DEFN_PID, " + "USER_GROUP_KEY, " + "TABLE_KEY, " + "CAN_VIEW_ALL, " + "CAN_VIEW_SOME, "
			+ "CAN_EDIT_VIEW, " + "CAN_DELETE_EDITABLE, " + "LIMIT_FLAG_KEY, " + "LIMIT_FLAG_VALUE, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.USER_GROUP_RIGHTS_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "USER_GROUP_RIGHTS_DEFN_PID, " + "USER_GROUP_KEY, " + "TABLE_KEY, " + "CAN_VIEW_ALL, "
			+ "CAN_VIEW_SOME, " + "CAN_EDIT_VIEW, " + "CAN_DELETE_EDITABLE, " + "LIMIT_FLAG_KEY, "
			+ "LIMIT_FLAG_VALUE, " + "REMINDER_KEY) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.USER_GROUP_RIGHTS_DEFNSSET " + "RECORD_NUM = ?, "
			+ "SET_KEY = ?, " + "COMMIT_PID = ?, " + "USER_GROUP_KEY = ?, " + "TABLE_KEY = ?, " + "CAN_VIEW_ALL = ?, "
			+ "CAN_VIEW_SOME = ?, " + "CAN_EDIT_VIEW = ?, " + "CAN_DELETE_EDITABLE = ?, " + "LIMIT_FLAG_KEY = ?, "
			+ "LIMIT_FLAG_VALUE = ?, " + "REMINDER_KEY = ? WHERE USER_GROUP_RIGHTS_DEFN_PID = ?";
