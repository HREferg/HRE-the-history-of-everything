...
public class UserTypeDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "USER_TYPE_DEFN_PID, " + "IS_USER_DEFN, " + "POOR_EYESIGHT, " + "IS_COLORBLIND, " + "MIN_MOUSE_USE, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.USER_TYPE_DEFNS WHERE USER_TYPE_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "USER_TYPE_DEFN_PID, " + "IS_USER_DEFN, " + "POOR_EYESIGHT, " + "IS_COLORBLIND, " + "MIN_MOUSE_USE, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW FROM PUBLIC.USER_TYPE_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.USER_TYPE_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "USER_TYPE_DEFN_PID, " + "IS_USER_DEFN, " + "POOR_EYESIGHT, " + "IS_COLORBLIND, "
			+ "MIN_MOUSE_USE, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.USER_TYPE_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_USER_DEFN = ?, " + "POOR_EYESIGHT = ?, " + "IS_COLORBLIND = ?, "
			+ "MIN_MOUSE_USE = ?, " + "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, "
