...
public class SentenceSetDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SENTENCE_SET_DEFN_PID, " + "IS_SYSTEM, " + "PARENT_TAG_TYPE_KEY, " + "PARENT_TAG_PID, "
			+ "SENTCE_STYLE_TYPE_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.SENTENCE_SET_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SENTENCE_SET_DEFN_PID, " + "IS_SYSTEM, " + "PARENT_TAG_TYPE_KEY, " + "PARENT_TAG_PID, "
			+ "SENTCE_STYLE_TYPE_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SENTENCE_SET_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
