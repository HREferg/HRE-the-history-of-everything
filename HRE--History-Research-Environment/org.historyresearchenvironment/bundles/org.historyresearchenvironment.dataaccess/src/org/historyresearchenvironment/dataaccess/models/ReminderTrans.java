...
private static final String INSERT = "INSERT INTO PUBLIC.REMINDER_TRANS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"REMINDER_TRAN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.REMINDER_TRANSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"PLUGIN_KEY = ?, " + 
...
"LANG_CODE = ?, " + 
"ENCODING_KEY = ?, " + 
"REMINDER = ? WHERE REMINDER_TRAN_PID = ?";
...
@Override
public ReminderTrans get(int key) throws SQLException {
model = new ReminderTrans();
...
*
* @param ReminderTranPid Contents of the REMINDER_TRAN_PID column
*/
...
*
* @param IsWholeScreen Contents of the IS_WHOLE_SCREEN column
*/
...
*
* @param ScreenKey Contents of the SCREEN_KEY column
*/
...
*
* @param ScreenPid Contents of the SCREEN_PID column
*/
