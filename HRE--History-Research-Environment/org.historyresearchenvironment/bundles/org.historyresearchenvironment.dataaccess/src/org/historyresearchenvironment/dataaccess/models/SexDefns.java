...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.SEX_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.SEX_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"SEX_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.SEX_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"REMINDER_KEY = ?, " + 
...
@Override
public SexDefns get(int key) throws SQLException {
model = new SexDefns();
...
*
* @param SexDefnPid Contents of the SEX_DEFN_PID column
*/
