...
@Override
public TableDefns get(int key) throws SQLException {
model = new TableDefns();
...
*
* @param TableDefnPid Contents of the TABLE_DEFN_PID column
*/
...
*
* @param LastRecordPid Contents of the LAST_RECORD_PID column
*/
...
*
* @param StorageTypeKey Contents of the STORAGE_TYPE_KEY column
*/
...
*
* @param RecordValidKey Contents of the RECORD_VALID_KEY column
*/
...
*
* @param HasFlags Contents of the HAS_FLAGS column
*/
...
*
* @param HasNotepads Contents of the HAS_NOTEPADS column
*/
