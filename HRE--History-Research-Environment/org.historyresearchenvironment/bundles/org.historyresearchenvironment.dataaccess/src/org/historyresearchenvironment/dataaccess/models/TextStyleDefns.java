...
public class TextStyleDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "TEXT_STYLE_DEFN_PID, " + "IS_USER_DEFN, " + "FONT_NAME, " + "FONT_SIZE, " + "FONT_IS_BOLD, "
			+ "FONT_IS_ITALIC, " + "FONT_UNDERLINED, " + "FONT_COLOR, " + "HIGHLIGHT_COLOR, " + "TEXT_LINK_KEY, "
			+ "MARKER1_LINK_KEY, " + "MARKER2_LINK_KEY, " + "MARKER3_LINK_KEY, " + "MARKER4_LINK_KEY, "
	...
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			...
			+ "FONT_IS_ITALIC, " + "FONT_UNDERLINED, " + "FONT_COLOR, " + "HIGHLIGHT_COLOR, " + "TEXT_LINK_KEY, "
			+ "MARKER1_LINK_KEY, " + "MARKER2_LINK_KEY, " + "MARKER3_LINK_KEY, " + "MARKER4_LINK_KEY, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW FROM PUBLIC.TEXT_STYLE_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.TEXT_STYLE_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "TEXT_STYLE_DEFN_PID, " + "IS_USER_DEFN, " + "FONT_NAME, " + "FONT_SIZE, "
			+ "FONT_IS_BOLD, " + "FONT_IS_ITALIC, " + "FONT_UNDERLINED, " + "FONT_COLOR, " + "HIGHLIGHT_COLOR, "
			+ "TEXT_LINK_KEY, " + "MARKER1_LINK_KEY, " + "MARKER2_LINK_KEY, " + "MARKER3_LINK_KEY, "
			+ "MARKER4_LINK_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.TEXT_STYLE_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_USER_DEFN = ?, " + "FONT_NAME = ?, " + "FONT_SIZE = ?, " + "FONT_IS_BOLD = ?, "
			+ "FONT_IS_ITALIC = ?, " + "FONT_UNDERLINED = ?, " + "FONT_COLOR = ?, " + "HIGHLIGHT_COLOR = ?, "
			+ "TEXT_LINK_KEY = ?, " + "MARKER1_LINK_KEY = ?, " + "MARKER2_LINK_KEY = ?, " + "MARKER3_LINK_KEY = ?, "
			+ "MARKER4_LINK_KEY = ?, " + "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, "
