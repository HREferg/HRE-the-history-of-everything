...
@Override
public SubstnTemplates get(int key) throws SQLException {
model = new SubstnTemplates();
...
*
* @param SubstnTemplatePid Contents of the SUBSTN_TEMPLATE_PID column
*/
...
*
* @param LayoutStyleClassKey Contents of the LAYOUT_STYLE_CLASS_KEY column
*/
