...
private static final String INSERT = "INSERT INTO PUBLIC.NAME_TEMPLATE_TYPE_DEFNS( " +
"RECORD_NUM, " +     
"SET_PID, " +     
"COMMIT_PID, " +     
"NAME_TEMPLATE_TYPE_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.NAME_TEMPLATE_TYPE_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_PID = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
"DISPLAY_ORDER = ?, " + 
"IS_DEFAULT = ?, " + 
"SHOW = ? WHERE NAME_TEMPLATE_TYPE_DEFN_PID = ?";
...
@Override
public NameTemplateTypeDefns get(int key) throws SQLException {
model = new NameTemplateTypeDefns();
...
*
* @param SetPid Contents of the SET_PID column
*/
...
*
* @param NameTemplateTypeDefnPid Contents of the NAME_TEMPLATE_TYPE_DEFN_PID column
*/
