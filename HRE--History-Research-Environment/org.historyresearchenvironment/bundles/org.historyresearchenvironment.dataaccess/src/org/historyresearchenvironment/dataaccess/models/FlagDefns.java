...
private static final String INSERT = "INSERT INTO PUBLIC.FLAG_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"FLAG_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.FLAG_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public FlagDefns get(int key) throws SQLException {
model = new FlagDefns();
...
*
* @param FlagDefnPid Contents of the FLAG_DEFN_PID column
*/
...
*
* @param FlagSlot Contents of the FLAG_SLOT column
*/
...
*
* @param States Contents of the STATES column
*/
...
*
* @param DfltState Contents of the DFLT_STATE column
*/
