...
@Override
public FieldDefns get(int key) throws SQLException {
model = new FieldDefns();
...
*
* @param FieldDefnPid Contents of the FIELD_DEFN_PID column
*/
...
*
* @param VersionName Contents of the VERSION_NAME column
*/
...
*
* @param SqlName Contents of the SQL_NAME column
*/
...
*
* @param SqlType Contents of the SQL_TYPE column
*/
...
*
* @param EncodeTypeKey Contents of the ENCODE_TYPE_KEY column
*/
...
*
* @param FieldFormatKey Contents of the FIELD_FORMAT_KEY column
*/
...
*
* @param FieldValidKey Contents of the FIELD_VALID_KEY column
*/
...
*
* @param MaxRecent Contents of the MAX_RECENT column
*/
...
*
* @param MaxFixed Contents of the MAX_FIXED column
*/
...
*
* @param LeftFieldPid Contents of the LEFT_FIELD_PID column
*/
...
*
* @param RightFieldPid Contents of the RIGHT_FIELD_PID column
*/
...
*
* @param HasAutoFillin Contents of the HAS_AUTO_FILLIN column
*/
