...
public class NotepadDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "NOTEPAD_DEFN_PID, " + "IS_SYSTEM, " + "PARENT_TYPE_KEY, " + "PARENT_SUB_TYPE_KEY, " + "LENGTH, "
			+ "UNITS_KEY, " + "NOTEPAD_STORAGE_KEY, " + "FIELD_TYPE_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, "
			+ "IS_DEFAULT, " + "SHOW FROM PUBLIC.NOTEPAD_DEFNS WHERE NOTEPAD_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "NOTEPAD_DEFN_PID, " + "IS_SYSTEM, " + "PARENT_TYPE_KEY, " + "PARENT_SUB_TYPE_KEY, " + "LENGTH, "
			+ "UNITS_KEY, " + "NOTEPAD_STORAGE_KEY, " + "FIELD_TYPE_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, "
			+ "IS_DEFAULT, " + "SHOW FROM PUBLIC.NOTEPAD_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.NOTEPAD_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "NOTEPAD_DEFN_PID, " + "IS_SYSTEM, " + "PARENT_TYPE_KEY, " + "PARENT_SUB_TYPE_KEY, "
			+ "LENGTH, " + "UNITS_KEY, " + "NOTEPAD_STORAGE_KEY, " + "FIELD_TYPE_KEY, " + "REMINDER_KEY, "
			+ "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.NOTEPAD_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "PARENT_TYPE_KEY = ?, " + "PARENT_SUB_TYPE_KEY = ?, "
			+ "LENGTH = ?, " + "UNITS_KEY = ?, " + "NOTEPAD_STORAGE_KEY = ?, " + "FIELD_TYPE_KEY = ?, "
			+ "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, " + "SHOW = ? WHERE NOTEPAD_DEFN_PID = ?";
