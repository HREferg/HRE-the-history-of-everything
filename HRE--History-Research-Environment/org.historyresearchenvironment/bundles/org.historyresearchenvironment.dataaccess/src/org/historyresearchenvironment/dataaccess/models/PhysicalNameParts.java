...
public class PhysicalNameParts extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PHYSICAL_NAME_PART_PID, " + "ELEMENT_PID, " + "THIS_NAME_EVENT_PID, " + "NEXT_NAME_EVENT_PID, "
			+ "SHARED, " + "LANG_CODE, " + "TRANS FROM PUBLIC.PHYSICAL_NAME_PARTS WHERE PHYSICAL_NAME_PART_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PHYSICAL_NAME_PART_PID, " + "ELEMENT_PID, " + "THIS_NAME_EVENT_PID, " + "NEXT_NAME_EVENT_PID, "
			+ "SHARED, " + "LANG_CODE, " + "TRANS FROM PUBLIC.PHYSICAL_NAME_PARTS";

	private static final String INSERT = "INSERT INTO PUBLIC.PHYSICAL_NAME_PARTS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "PHYSICAL_NAME_PART_PID, " + "ELEMENT_PID, " + "THIS_NAME_EVENT_PID, "
			+ "NEXT_NAME_EVENT_PID, " + "SHARED, " + "LANG_CODE, " + "TRANS) VALUES (?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.PHYSICAL_NAME_PARTSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "ELEMENT_PID = ?, " + "THIS_NAME_EVENT_PID = ?, " + "NEXT_NAME_EVENT_PID = ?, "
			+ "SHARED = ?, " + "LANG_CODE = ?, " + "TRANS = ? WHERE PHYSICAL_NAME_PART_PID = ?";
	 ...
	 *
	 * @param PhysicalNamePartPid
	 *            Contents of the PHYSICAL_NAME_PART_PID column
	 */
