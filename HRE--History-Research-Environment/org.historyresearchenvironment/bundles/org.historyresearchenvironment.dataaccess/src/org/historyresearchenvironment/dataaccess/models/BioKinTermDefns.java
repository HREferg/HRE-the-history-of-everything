...
public class BioKinTermDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "BIO_KIN_TERM_DEFN_PID, " + "CURRENT_IS_FEMALE, " + "FOCUS_IS_FEMALE, " + "THIS_GENERATION, "
			+ "REMOVED_GENERATION, " + "KIN_ETHNICITY_KEY, " + "ANCESTOR_KIN_CODE, " + "DESCENDANT_KIN_CODE, "
			+ "KIN_TERM_TRANS_KEY, " + "REMINDER_KEY, "
			+ "SHOW FROM PUBLIC.BIO_KIN_TERM_DEFNS WHERE BIO_KIN_TERM_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "BIO_KIN_TERM_DEFN_PID, " + "CURRENT_IS_FEMALE, " + "FOCUS_IS_FEMALE, " + "THIS_GENERATION, "
			+ "REMOVED_GENERATION, " + "KIN_ETHNICITY_KEY, " + "ANCESTOR_KIN_CODE, " + "DESCENDANT_KIN_CODE, "
			+ "KIN_TERM_TRANS_KEY, " + "REMINDER_KEY, " + "SHOW FROM PUBLIC.BIO_KIN_TERM_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.BIO_KIN_TERM_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "BIO_KIN_TERM_DEFN_PID, " + "CURRENT_IS_FEMALE, " + "FOCUS_IS_FEMALE, "
			+ "THIS_GENERATION, " + "REMOVED_GENERATION, " + "KIN_ETHNICITY_KEY, " + "ANCESTOR_KIN_CODE, "
			+ "DESCENDANT_KIN_CODE, " + "KIN_TERM_TRANS_KEY, " + "REMINDER_KEY, " + "SHOW) VALUES (?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.BIO_KIN_TERM_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "CURRENT_IS_FEMALE = ?, " + "FOCUS_IS_FEMALE = ?, " + "THIS_GENERATION = ?, "
			+ "REMOVED_GENERATION = ?, " + "KIN_ETHNICITY_KEY = ?, " + "ANCESTOR_KIN_CODE = ?, "
			+ "DESCENDANT_KIN_CODE = ?, " + "KIN_TERM_TRANS_KEY = ?, " + "REMINDER_KEY = ?, "
