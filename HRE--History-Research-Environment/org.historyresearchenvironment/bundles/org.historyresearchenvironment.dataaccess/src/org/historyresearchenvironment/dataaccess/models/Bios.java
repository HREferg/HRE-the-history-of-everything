...
"BEST_BIRTH_PID, " +
"BEST_DEATH_PID, " +
"BEST_BIO_MALE_PARENT_PID, " +
"BEST_BIO_FEMALE_PARENT_PID, " +
"USE_BIO_MALE_PARENT, " +
"USE_BIO_FEMALE_PARENT, " +
"BEST_NON_BIO_PARENT1_PID, " +
"BEST_NON_BIO_PARENT2_PID, " +
"BEST_IMAGE_PID, " +
"SEX_KEY, " +
"LIVING_KEY, " +
"SPERM_PROVIDER_ISSUE_ORDER, " +
"EGG_PROVIDER_ISSUE_ORDER, " +
"SURETY, " +
...
"EGG_PROVIDER_ISSUE_ORDER, " +  
"SURETY, " +  
"FLAGS FROM PUBLIC.BIOS";

private static final String INSERT = "INSERT INTO PUBLIC.BIOS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"BIO_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.BIOSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
*
* @param BestBirthPid Contents of the BEST_BIRTH_PID column
*/
...
*
* @param BestDeathPid Contents of the BEST_DEATH_PID column
*/
...
*
* @param BestBioMaleParentPid Contents of the BEST_BIO_MALE_PARENT_PID column
*/
...
*
* @param BestBioFemaleParentPid Contents of the BEST_BIO_FEMALE_PARENT_PID column
*/
...
*
* @param UseBioMaleParent Contents of the USE_BIO_MALE_PARENT column
*/
...
*
* @param UseBioFemaleParent Contents of the USE_BIO_FEMALE_PARENT column
*/
...
*
* @param BestNonBioParent1Pid Contents of the BEST_NON_BIO_PARENT1_PID column
*/
...
*
* @param BestNonBioParent2Pid Contents of the BEST_NON_BIO_PARENT2_PID column
*/
...
*
* @param SexKey Contents of the SEX_KEY column
*/
...
*
* @param LivingKey Contents of the LIVING_KEY column
*/
...
*
* @param SpermProviderIssueOrder Contents of the SPERM_PROVIDER_ISSUE_ORDER column
*/
...
*
* @param EggProviderIssueOrder Contents of the EGG_PROVIDER_ISSUE_ORDER column
*/
