...
public class SubstnTemplateDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSTN_TEMPLATE_DEFN_PID, " + "IS_SYSTEM, " + "IS_TEXT_LAYOUT, " + "IS_TEXT_STYLE, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.SUBSTN_TEMPLATE_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SUBSTN_TEMPLATE_DEFN_PID, " + "IS_SYSTEM, " + "IS_TEXT_LAYOUT, " + "IS_TEXT_STYLE, "
			+ "SCRIPT_GROUP_KEY, " + "SCRIPT_KEY, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "SHOW) VALUES (?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SUBSTN_TEMPLATE_DEFNSSET " + "RECORD_NUM = ?, "
			+ "SET_KEY = ?, " + "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "IS_TEXT_LAYOUT = ?, " + "IS_TEXT_STYLE = ?, "
			+ "SCRIPT_GROUP_KEY = ?, " + "SCRIPT_KEY = ?, " + "REMINDER_KEY = ?, " + "DISPLAY_ORDER = ?, "
