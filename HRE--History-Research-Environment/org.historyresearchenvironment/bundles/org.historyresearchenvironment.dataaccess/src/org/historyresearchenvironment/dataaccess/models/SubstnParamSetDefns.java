...
"REMINDER_KEY, " +  
"DISPLAY_ORDER, " +  
"SHOW FROM PUBLIC.SUBSTN_PARAM_SET_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.SUBSTN_PARAM_SET_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"SUBSTN_PARAM_SET_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.SUBSTN_PARAM_SET_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public SubstnParamSetDefns get(int key) throws SQLException {
model = new SubstnParamSetDefns();
...
*
* @param SubstnParamSetDefnPid Contents of the SUBSTN_PARAM_SET_DEFN_PID column
*/
...
*
* @param EvalDataScriptGroupKey Contents of the EVAL_DATA_SCRIPT_GROUP_KEY column
*/
...
*
* @param EvalDataScriptPid Contents of the EVAL_DATA_SCRIPT_PID column
*/
