...
@Override
public MemoDefns get(int key) throws SQLException {
model = new MemoDefns();
...
*
* @param MemoDefnPid Contents of the MEMO_DEFN_PID column
*/
...
*
* @param MemoSetKey Contents of the MEMO_SET_KEY column
*/
