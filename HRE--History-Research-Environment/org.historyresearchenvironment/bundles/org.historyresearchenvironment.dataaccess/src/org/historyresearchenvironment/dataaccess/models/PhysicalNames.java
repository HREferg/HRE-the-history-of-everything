...
public class PhysicalNames extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PHYSICAL_NAME_PID, " + "IS_SYSTEM, " + "PARENT_PID, " + "PARENT_SUB_TYPE_KEY, " + "NAME_TAG_KEY, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.PHYSICAL_NAMES( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "PHYSICAL_NAME_PID, " + "IS_SYSTEM, " + "PARENT_PID, " + "PARENT_SUB_TYPE_KEY, "
	...
	private static final String UPDATE = "UPDATE PUBLIC.PHYSICAL_NAMESSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			...
			+ "SENTCE_TYPE_KEY = ?, " + "SENTCE_STYLE_KEY = ?, " + "MEMO_SET_PID = ? WHERE PHYSICAL_NAME_PID = ?";
	 ...
	 *
	 * @param PhysicalNamePid
	 *            Contents of the PHYSICAL_NAME_PID column
	 */
