...
public class LivingTypeDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, " + "LIVING_DEFN_PID, "
			+ "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.LIVING_TYPE_DEFNS WHERE LIVING_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "LIVING_DEFN_PID, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.LIVING_TYPE_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.LIVING_TYPE_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "LIVING_DEFN_PID, " + "REMINDER_KEY, " + "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.LIVING_TYPE_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
	...
	public LivingTypeDefns(int LivingDefnPid) throws SQLException {
		super();
	 ...
	 *
	 * @param LivingDefnPid
	 *            Contents of the LIVING_DEFN_PID column
	 */
