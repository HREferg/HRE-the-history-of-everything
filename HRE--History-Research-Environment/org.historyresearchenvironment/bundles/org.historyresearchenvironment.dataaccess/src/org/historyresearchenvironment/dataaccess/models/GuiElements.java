...
"GUI_ELEMENT_PID, " +
"PLUGIN_KEY, " +
"GUI_SCREEN_PID FROM PUBLIC.GUI_ELEMENTS WHERE GUI_ELEMENT_PID = ?";
...
"GUI_ELEMENT_PID, " +  
"PLUGIN_KEY, " +  
"GUI_SCREEN_PID FROM PUBLIC.GUI_ELEMENTS";

private static final String INSERT = "INSERT INTO PUBLIC.GUI_ELEMENTS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"GUI_ELEMENT_PID, " +     
"PLUGIN_KEY, " +     
"GUI_SCREEN_PID) VALUES (?, " +
"?, " +
"?, " +
"?, " +
"?, " +
...
private static final String UPDATE = "UPDATE PUBLIC.GUI_ELEMENTSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"PLUGIN_KEY = ?, " + 
"GUI_SCREEN_PID = ? WHERE GUI_ELEMENT_PID = ?";
...
@Override
public GuiElements get(int key) throws SQLException {
model = new GuiElements();
...
*
* @param GuiElementPid Contents of the GUI_ELEMENT_PID column
*/
...
*
* @param GuiScreenPid Contents of the GUI_SCREEN_PID column
*/
