...
@Override
public SubsetSingleDefns get(int key) throws SQLException {
model = new SubsetSingleDefns();
...
*
* @param SubsetSingleDefnPid Contents of the SUBSET_SINGLE_DEFN_PID column
*/
...
*
* @param ReferPid Contents of the REFER_PID column
*/
...
* Set the Count field
*
* @param Count Contents of the COUNT column
*/
