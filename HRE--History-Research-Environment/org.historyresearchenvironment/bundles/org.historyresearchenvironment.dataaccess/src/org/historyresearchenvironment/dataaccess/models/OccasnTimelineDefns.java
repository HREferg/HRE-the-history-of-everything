...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.OCCASN_TIMELINE_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.OCCASN_TIMELINE_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"OCCASN_TIMELINE_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.OCCASN_TIMELINE_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public OccasnTimelineDefns get(int key) throws SQLException {
model = new OccasnTimelineDefns();
...
/**
* Get the OccasnTimelineDefnPid field.
*
* @return Contents of the OCCASN_TIMELINE_DEFN_PID column
*/
...
/**
* Set the OccasnTimelineDefnPid field
*
* @param OccasnTimelineDefnPid Contents of the OCCASN_TIMELINE_DEFN_PID column
*/
