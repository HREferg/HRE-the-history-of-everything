...
@Override
public Hintervals get(int key) throws SQLException {
model = new Hintervals();
...
*
* @param HintervalPid Contents of the HINTERVAL_PID column
*/
...
*
* @param IsHumanCalendar Contents of the IS_HUMAN_CALENDAR column
*/
...
*
* @param Hinterval1 Contents of the HINTERVAL1 column
*/
...
*
* @param Hinterval2 Contents of the HINTERVAL2 column
*/
...
*
* @param SortHinterval1 Contents of the SORT_HINTERVAL1 column
*/
...
*
* @param SortHinterval2 Contents of the SORT_HINTERVAL2 column
*/
...
*
* @param HintervalTypeKey Contents of the HINTERVAL_TYPE_KEY column
*/
...
*
* @param NamedMemoPid Contents of the NAMED_MEMO_PID column
*/
