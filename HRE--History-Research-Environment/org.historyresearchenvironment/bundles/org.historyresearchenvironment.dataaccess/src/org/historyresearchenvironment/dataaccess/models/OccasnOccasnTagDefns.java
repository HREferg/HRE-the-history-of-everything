...
@Override
public OccasnOccasnTagDefns get(int key) throws SQLException {
model = new OccasnOccasnTagDefns();
...
*
* @param OccasnOccasnTagDefnPid Contents of the OCCASN_OCCASN_TAG_DEFN_PID column
*/
...
*
* @param ABRoleNamePairKey Contents of the A_B_ROLE_NAME_PAIR_KEY column
*/
...
*
* @param ASentceSetPid Contents of the A_SENTCE_SET_PID column
*/
...
*
* @param BSentceSetPid Contents of the B_SENTCE_SET_PID column
*/
