...
public class ViewpointElements extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "VIEWPOINT_ELEMENT_PID, " + "VIEWPOINT_PID, " + "SCREEN_CONFIG_PID, " + "IS_MASTER, " + "IS_SECOND_COPY, "
			+ "AUTO_UPDATE, " + "SHOW_ON_OPEN FROM PUBLIC.VIEWPOINT_ELEMENTS WHERE VIEWPOINT_ELEMENT_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "VIEWPOINT_ELEMENT_PID, " + "VIEWPOINT_PID, " + "SCREEN_CONFIG_PID, " + "IS_MASTER, " + "IS_SECOND_COPY, "
			+ "AUTO_UPDATE, " + "SHOW_ON_OPEN FROM PUBLIC.VIEWPOINT_ELEMENTS";

	private static final String INSERT = "INSERT INTO PUBLIC.VIEWPOINT_ELEMENTS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "VIEWPOINT_ELEMENT_PID, " + "VIEWPOINT_PID, " + "SCREEN_CONFIG_PID, " + "IS_MASTER, "
			+ "IS_SECOND_COPY, " + "AUTO_UPDATE, " + "SHOW_ON_OPEN) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.VIEWPOINT_ELEMENTSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "VIEWPOINT_PID = ?, " + "SCREEN_CONFIG_PID = ?, " + "IS_MASTER = ?, "
			+ "IS_SECOND_COPY = ?, " + "AUTO_UPDATE = ?, " + "SHOW_ON_OPEN = ? WHERE VIEWPOINT_ELEMENT_PID = ?";
