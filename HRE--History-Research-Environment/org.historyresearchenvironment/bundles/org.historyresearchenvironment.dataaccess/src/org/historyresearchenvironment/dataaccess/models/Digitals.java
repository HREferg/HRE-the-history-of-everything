...
@Override
public Digitals get(int key) throws SQLException {
model = new Digitals();
...
*
* @param DigitalPid Contents of the DIGITAL_PID column
*/
...
*
* @param IsInternal Contents of the IS_INTERNAL column
*/
...
*
* @param IsBinary Contents of the IS_BINARY column
*/
...
*
* @param BinaryContent Contents of the BINARY_CONTENT column
*/
...
*
* @param CharContent Contents of the CHAR_CONTENT column
*/
...
*
* @param FilePath Contents of the FILE_PATH column
*/
...
*
* @param PathIsFull Contents of the PATH_IS_FULL column
*/
...
*
* @param ImageWidth Contents of the IMAGE_WIDTH column
*/
...
*
* @param ImageHeight Contents of the IMAGE_HEIGHT column
*/
...
*
* @param EditedCopyPid Contents of the EDITED_COPY_PID column
*/
