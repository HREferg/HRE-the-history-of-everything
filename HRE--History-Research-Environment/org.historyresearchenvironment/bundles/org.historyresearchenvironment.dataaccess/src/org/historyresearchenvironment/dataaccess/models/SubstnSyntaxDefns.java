...
@Override
public SubstnSyntaxDefns get(int key) throws SQLException {
model = new SubstnSyntaxDefns();
...
*
* @param SubstnSyntaxDefnPid Contents of the SUBSTN_SYNTAX_DEFN_PID column
*/
...
*
* @param EnclosesMarkup Contents of the ENCLOSES_MARKUP column
*/
...
*
* @param InternalBeginMark Contents of the INTERNAL_BEGIN_MARK column
*/
...
*
* @param VisibleBeginMark Contents of the VISIBLE_BEGIN_MARK column
*/
...
*
* @param InternalEndMark Contents of the INTERNAL_END_MARK column
*/
...
*
* @param VisibleEndMark Contents of the VISIBLE_END_MARK column
*/
...
*
* @param InternalBeginTrue Contents of the INTERNAL_BEGIN_TRUE column
*/
...
*
* @param VisibleBeginTrue Contents of the VISIBLE_BEGIN_TRUE column
*/
...
*
* @param InternalEndTrue Contents of the INTERNAL_END_TRUE column
*/
...
*
* @param VisibleEndTrue Contents of the VISIBLE_END_TRUE column
*/
...
*
* @param InternalDividerMark Contents of the INTERNAL_DIVIDER_MARK column
*/
...
*
* @param VisibleDividerMark Contents of the VISIBLE_DIVIDER_MARK column
*/
