...
"SET_KEY, " +
"COMMIT_PID, " +
"NAME_OUT_TEMPLATE_DEFN_PID, " +
"IS_SYSTEM, " +
"PARENT_NAME_STYLE_TYPE_KEY, " +
"TEMPLATE_TYPE_KEY, " +
"SORTING_ONLY, " +
"REMINDER_KEY, " +
"DISPLAY_ORDER, " +
...
private static final String INSERT = "INSERT INTO PUBLIC.NAME_OUT_TEMPLATE_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"NAME_OUT_TEMPLATE_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.NAME_OUT_TEMPLATE_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
"DISPLAY_ORDER = ?, " + 
"IS_DEFAULT = ?, " + 
"SHOW = ? WHERE NAME_OUT_TEMPLATE_DEFN_PID = ?";
...
@Override
public NameOutTemplateDefns get(int key) throws SQLException {
model = new NameOutTemplateDefns();
...
*
* @param NameOutTemplateDefnPid Contents of the NAME_OUT_TEMPLATE_DEFN_PID column
*/
...
*
* @param ParentNameStyleTypeKey Contents of the PARENT_NAME_STYLE_TYPE_KEY column
*/
...
*
* @param SortingOnly Contents of the SORTING_ONLY column
*/
