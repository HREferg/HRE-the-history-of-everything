...
private static final String INSERT = "INSERT INTO PUBLIC.CONTAIN_NOTEPADS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"CONTAIN_NOTEPAD_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.CONTAIN_NOTEPADSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
"PARENT_SUB_TYPE_KEY = ?, " + 
"NOTEPAD_DEFN_KEY = ?, " + 
"NOTEPAD = ? WHERE CONTAIN_NOTEPAD_PID = ?";
...
@Override
public ContainNotepads get(int key) throws SQLException {
model = new ContainNotepads();
...
*
* @param ContainNotepadPid Contents of the CONTAIN_NOTEPAD_PID column
*/
