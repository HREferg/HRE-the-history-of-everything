...
@Override
public Citations get(int key) throws SQLException {
model = new Citations();
...
*
* @param CitationPid Contents of the CITATION_PID column
*/
...
*
* @param CitnTypeKey Contents of the CITN_TYPE_KEY column
*/
...
*
* @param CitingPid Contents of the CITING_PID column
*/
...
*
* @param SourceSubTypeKey Contents of the SOURCE_SUB_TYPE_KEY column
*/
...
*
* @param SourcePid Contents of the SOURCE_PID column
*/
