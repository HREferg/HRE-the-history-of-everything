...
private static final String INSERT = "INSERT INTO PUBLIC.HINTERVAL_MODIFIER_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"HINTERVAL_MODIFIER_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.HINTERVAL_MODIFIER_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"REMINDER_KEY = ?, " + 
...
@Override
public HintervalModifierDefns get(int key) throws SQLException {
model = new HintervalModifierDefns();
...
*
* @param HintervalModifierDefnPid Contents of the HINTERVAL_MODIFIER_DEFN_PID column
*/
