...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.OCCASN_TIMELINE_ELMNTS";

private static final String INSERT = "INSERT INTO PUBLIC.OCCASN_TIMELINE_ELMNTS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"OCCASN_TIMELINE_ELMNT_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.OCCASN_TIMELINE_ELMNTSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public OccasnTimelineElmnts get(int key) throws SQLException {
model = new OccasnTimelineElmnts();
...
*
* @param OccasnTimelineElmntPid Contents of the OCCASN_TIMELINE_ELMNT_PID column
*/
...
*
* @param TimelinePid Contents of the TIMELINE_PID column
*/
