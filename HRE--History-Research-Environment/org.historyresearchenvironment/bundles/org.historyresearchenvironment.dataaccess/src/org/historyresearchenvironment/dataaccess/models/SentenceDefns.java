...
@Override
public SentenceDefns get(int key) throws SQLException {
model = new SentenceDefns();
...
*
* @param SentenceTemplateDefnPid Contents of the SENTENCE_TEMPLATE_DEFN_PID column
*/
...
*
* @param SentenceSetKey Contents of the SENTENCE_SET_KEY column
*/
