...
public class BioKinTermTrans extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "BIO_KIN_TERM_TRAN_PID, " + "KIN_ETHNICITY_KEY, " + "KIN_TERM_HAS_SUBSTN, " + "LANG_CODE, "
			+ "KIN_TERM FROM PUBLIC.BIO_KIN_TERM_TRANS WHERE BIO_KIN_TERM_TRAN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "BIO_KIN_TERM_TRAN_PID, " + "KIN_ETHNICITY_KEY, " + "KIN_TERM_HAS_SUBSTN, " + "LANG_CODE, "
			+ "KIN_TERM FROM PUBLIC.BIO_KIN_TERM_TRANS";

	private static final String INSERT = "INSERT INTO PUBLIC.BIO_KIN_TERM_TRANS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "BIO_KIN_TERM_TRAN_PID, " + "KIN_ETHNICITY_KEY, " + "KIN_TERM_HAS_SUBSTN, "
			+ "LANG_CODE, " + "KIN_TERM) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.BIO_KIN_TERM_TRANSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "KIN_ETHNICITY_KEY = ?, " + "KIN_TERM_HAS_SUBSTN = ?, " + "LANG_CODE = ?, "
