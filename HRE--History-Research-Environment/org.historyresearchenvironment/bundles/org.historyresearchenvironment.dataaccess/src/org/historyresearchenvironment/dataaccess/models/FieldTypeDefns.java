...
private static final String INSERT = "INSERT INTO PUBLIC.FIELD_TYPE_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"FIELD_TYPE_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.FIELD_TYPE_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"DATA_TYPE_PID = ?, " + 
...
"DISPLAY_ORDER = ?, " + 
"IS_DEFAULT = ?, " + 
"SHOW = ? WHERE FIELD_TYPE_DEFN_PID = ?";
...
@Override
public FieldTypeDefns get(int key) throws SQLException {
model = new FieldTypeDefns();
...
*
* @param FieldTypeDefnPid Contents of the FIELD_TYPE_DEFN_PID column
*/
...
*
* @param DataTypePid Contents of the DATA_TYPE_PID column
*/
...
*
* @param InFormatPid Contents of the IN_FORMAT_PID column
*/
...
*
* @param OutFormatKey Contents of the OUT_FORMAT_KEY column
*/
...
*
* @param MinInteger Contents of the MIN_INTEGER column
*/
...
*
* @param MaxInteger Contents of the MAX_INTEGER column
*/
...
*
* @param MinFloat Contents of the MIN_FLOAT column
*/
...
*
* @param MaxFloat Contents of the MAX_FLOAT column
*/
...
*
* @param MaxStringLen Contents of the MAX_STRING_LEN column
*/
...
*
* @param MinStringLen Contents of the MIN_STRING_LEN column
*/
...
*
* @param EncodingKey Contents of the ENCODING_KEY column
*/
