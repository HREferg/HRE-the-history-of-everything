...
"FIXED03_PID, " +
"FIXED04_PID, " +
"FIXED05_PID FROM PUBLIC.FIELD_RECENTS WHERE FIELD_RECENT_PID = ?";
...
"FIXED03_PID, " +  
"FIXED04_PID, " +  
"FIXED05_PID FROM PUBLIC.FIELD_RECENTS";

private static final String INSERT = "INSERT INTO PUBLIC.FIELD_RECENTS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"FIELD_RECENT_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.FIELD_RECENTSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"TABLE_KEY = ?, " + 
...
"FIXED03_PID = ?, " + 
"FIXED04_PID = ?, " + 
"FIXED05_PID = ? WHERE FIELD_RECENT_PID = ?";
...
@Override
public FieldRecents get(int key) throws SQLException {
model = new FieldRecents();
...
*
* @param FieldRecentPid Contents of the FIELD_RECENT_PID column
*/
...
*
* @param FieldPid Contents of the FIELD_PID column
*/
...
*
* @param Recent01Pid Contents of the RECENT01_PID column
*/
...
*
* @param Recent02Pid Contents of the RECENT02_PID column
*/
...
*
* @param Recent03Pid Contents of the RECENT03_PID column
*/
...
*
* @param Recent04Pid Contents of the RECENT04_PID column
*/
...
*
* @param Recent05Pid Contents of the RECENT05_PID column
*/
...
*
* @param Recent06Pid Contents of the RECENT06_PID column
*/
...
*
* @param Recent07Pid Contents of the RECENT07_PID column
*/
...
*
* @param Recent08Pid Contents of the RECENT08_PID column
*/
...
*
* @param Recent09Pid Contents of the RECENT09_PID column
*/
...
*
* @param Recent10Pid Contents of the RECENT10_PID column
*/
...
*
* @param Recent11Pid Contents of the RECENT11_PID column
*/
...
*
* @param Recent12Pid Contents of the RECENT12_PID column
*/
...
*
* @param Recent13Pid Contents of the RECENT13_PID column
*/
...
*
* @param Recent14Pid Contents of the RECENT14_PID column
*/
...
*
* @param Recent15Pid Contents of the RECENT15_PID column
*/
...
*
* @param Fixed01Pid Contents of the FIXED01_PID column
*/
...
*
* @param Fixed02Pid Contents of the FIXED02_PID column
*/
...
*
* @param Fixed03Pid Contents of the FIXED03_PID column
*/
...
*
* @param Fixed04Pid Contents of the FIXED04_PID column
*/
...
*
* @param Fixed05Pid Contents of the FIXED05_PID column
*/
