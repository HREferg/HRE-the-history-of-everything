...
public class OccasnOccasns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "OCCASN_OCCASN_PID, " + "IS_SYSTEM, " + "OCCASN_OCCASN_TAG_KEY, " + "A_OCCASN_SUB_TYPE_KEY, "
			+ "A_OCCASN_PID, " + "B_OCCASN_SUB_TYPE_KEY, " + "B_OCCASN_PID, " + "THEME_KEY, " + "SENTCE_STYLE_KEY, "
			+ "A_B_SENTCE_SET_PID, " + "B_A_SENTCE_SET_PID, " + "MEMO_SET_PID, " + "DISPLAY_ORDER, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.OCCASN_OCCASNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "OCCASN_OCCASN_PID, " + "IS_SYSTEM, " + "OCCASN_OCCASN_TAG_KEY, "
			+ "A_OCCASN_SUB_TYPE_KEY, " + "A_OCCASN_PID, " + "B_OCCASN_SUB_TYPE_KEY, " + "B_OCCASN_PID, "
			+ "THEME_KEY, " + "SENTCE_STYLE_KEY, " + "A_B_SENTCE_SET_PID, " + "B_A_SENTCE_SET_PID, " + "MEMO_SET_PID, "
			+ "DISPLAY_ORDER, " + "FLAGS) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.OCCASN_OCCASNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "OCCASN_OCCASN_TAG_KEY = ?, " + "A_OCCASN_SUB_TYPE_KEY = ?, "
			+ "A_OCCASN_PID = ?, " + "B_OCCASN_SUB_TYPE_KEY = ?, " + "B_OCCASN_PID = ?, " + "THEME_KEY = ?, "
			+ "SENTCE_STYLE_KEY = ?, " + "A_B_SENTCE_SET_PID = ?, " + "B_A_SENTCE_SET_PID = ?, " + "MEMO_SET_PID = ?, "
			+ "DISPLAY_ORDER = ?, " + "FLAGS = ? WHERE OCCASN_OCCASN_PID = ?";
	 ...
	 * Constructor
	 *
	 * @param OccasnOccasnPid
	 *            Primary key
	 * @throws SQLException
	 *             If database access has failed
	 */

	public OccasnOccasns(int OccasnOccasnPid) throws SQLException {
		super();
	 ...
	 *
	 * @param AOccasnPid
	 *            Contents of the A_OCCASN_PID column
	 */
	 ...
	 *
	 * @param BOccasnPid
	 *            Contents of the B_OCCASN_PID column
	 */
	 ...
	 *
	 * @param OccasnOccasnPid
	 *            Contents of the OCCASN_OCCASN_PID column
	 */
	 ...
	 *
	 * @param OccasnOccasnTagKey
	 *            Contents of the OCCASN_OCCASN_TAG_KEY column
	 */
