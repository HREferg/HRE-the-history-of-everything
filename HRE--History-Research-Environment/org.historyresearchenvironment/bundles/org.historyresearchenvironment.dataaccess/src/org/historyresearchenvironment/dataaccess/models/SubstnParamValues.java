...
"DEFLT_PARAM_STEP_PID, " +  
"DISPLAY_ORDER, " +  
"SHOW FROM PUBLIC.SUBSTN_PARAM_VALUES";

private static final String INSERT = "INSERT INTO PUBLIC.SUBSTN_PARAM_VALUES( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"SUBSTN_PARAM_VALUE_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.SUBSTN_PARAM_VALUESSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public SubstnParamValues get(int key) throws SQLException {
model = new SubstnParamValues();
...
*
* @param SubstnParamValuePid Contents of the SUBSTN_PARAM_VALUE_PID column
*/
...
*
* @param ParamSetKey Contents of the PARAM_SET_KEY column
*/
...
*
* @param ParamNameKey Contents of the PARAM_NAME_KEY column
*/
...
*
* @param ValueIsDataAlias Contents of the VALUE_IS_DATA_ALIAS column
*/
...
*
* @param ValueIsOtherAlias Contents of the VALUE_IS_OTHER_ALIAS column
*/
...
*
* @param AliasKey Contents of the ALIAS_KEY column
*/
...
*
* @param DefltParamStepPid Contents of the DEFLT_PARAM_STEP_PID column
*/
