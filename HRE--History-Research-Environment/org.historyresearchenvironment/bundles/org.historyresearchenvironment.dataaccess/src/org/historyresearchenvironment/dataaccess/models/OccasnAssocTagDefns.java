...
@Override
public OccasnAssocTagDefns get(int key) throws SQLException {
model = new OccasnAssocTagDefns();
...
*
* @param OccasnAssocTagDefnPid Contents of the OCCASN_ASSOC_TAG_DEFN_PID column
*/
...
*
* @param OccasnTagTypeKey Contents of the OCCASN_TAG_TYPE_KEY column
*/
...
*
* @param RoleNameKey Contents of the ROLE_NAME_KEY column
*/
...
*
* @param MinInRole Contents of the MIN_IN_ROLE column
*/
...
*
* @param MaxInRole Contents of the MAX_IN_ROLE column
*/
...
*
* @param IsRequiredRole Contents of the IS_REQUIRED_ROLE column
*/
...
*
* @param GroupKey Contents of the GROUP_KEY column
*/
...
*
* @param TagRuleKey Contents of the TAG_RULE_KEY column
*/
