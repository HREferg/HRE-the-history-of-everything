...
"BEST_IMAGE_PID, " +  
"SURETY, " +  
"FLAGS FROM PUBLIC.PHYSICALS";

private static final String INSERT = "INSERT INTO PUBLIC.PHYSICALS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"PHYSICAL_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.PHYSICALSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public Physicals get(int key) throws SQLException {
model = new Physicals();
...
*
* @param PhysicalPid Contents of the PHYSICAL_PID column
*/
