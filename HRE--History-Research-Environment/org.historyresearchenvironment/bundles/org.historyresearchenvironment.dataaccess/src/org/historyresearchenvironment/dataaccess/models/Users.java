...
private static final String UPDATE = "UPDATE PUBLIC.USERSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"LOGON_NAME = ?, " + 
...
@Override
public Users get(int key) throws SQLException {
model = new Users();
...
*
* @param LogonName Contents of the LOGON_NAME column
*/
...
*
* @param UserName Contents of the USER_NAME column
*/
...
*
* @param Password Contents of the PASSWORD column
*/
...
* Set the Email field
*
* @param Email Contents of the EMAIL column
*/
...
*
* @param UserTypePid Contents of the USER_TYPE_PID column
*/
...
*
* @param UserGroupPid Contents of the USER_GROUP_PID column
*/
