...
"DISPLAY_ORDER, " +
"IS_DEFAULT, " +
"SHOW FROM PUBLIC.TAG_GROUP_DEFNS WHERE TAG_GROUP_DEFN_PID = ?";
...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.TAG_GROUP_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.TAG_GROUP_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"TAG_GROUP_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.TAG_GROUP_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public TagGroupDefns get(int key) throws SQLException {
model = new TagGroupDefns();
...
*
* @param TagGroupDefnPid Contents of the TAG_GROUP_DEFN_PID column
*/
...
*
* @param IsMajorGroup Contents of the IS_MAJOR_GROUP column
*/
...
*
* @param MajorGrpKey Contents of the MAJOR_GRP_KEY column
*/
...
*
* @param MinorGrpKey Contents of the MINOR_GRP_KEY column
*/
