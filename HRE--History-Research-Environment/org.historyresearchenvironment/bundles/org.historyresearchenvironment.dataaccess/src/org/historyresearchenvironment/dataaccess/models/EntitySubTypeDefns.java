...
@Override
public EntitySubTypeDefns get(int key) throws SQLException {
model = new EntitySubTypeDefns();
...
*
* @param EntitySubTypePid Contents of the ENTITY_SUB_TYPE_PID column
*/
...
*
* @param BaseEntityTypeKey Contents of the BASE_ENTITY_TYPE_KEY column
*/
...
*
* @param BaseEntitySubTypeKey Contents of the BASE_ENTITY_SUB_TYPE_KEY column
*/
...
*
* @param GroupOfTypeKey Contents of the GROUP_OF_TYPE_KEY column
*/
...
*
* @param GroupOfSubTypeKey Contents of the GROUP_OF_SUB_TYPE_KEY column
*/
