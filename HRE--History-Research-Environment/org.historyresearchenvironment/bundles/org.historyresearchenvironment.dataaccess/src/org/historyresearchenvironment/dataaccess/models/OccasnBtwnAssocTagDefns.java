...
@Override
public OccasnBtwnAssocTagDefns get(int key) throws SQLException {
model = new OccasnBtwnAssocTagDefns();
...
*
* @param OccasnBtwnAssocTagDefnPid Contents of the OCCASN_BTWN_ASSOC_TAG_DEFN_PID column
*/
...
*
* @param AssocATypeKey Contents of the ASSOC_A_TYPE_KEY column
*/
...
*
* @param AssocASubTypeKey Contents of the ASSOC_A_SUB_TYPE_KEY column
*/
...
*
* @param AssocBTypeKey Contents of the ASSOC_B_TYPE_KEY column
*/
...
*
* @param AssocBSubTypeKey Contents of the ASSOC_B_SUB_TYPE_KEY column
*/
...
*
* @param RolePairKey Contents of the ROLE_PAIR_KEY column
*/
...
*
* @param TagGroupKey Contents of the TAG_GROUP_KEY column
*/
...
*
* @param ASubjSentceSetKey Contents of the A_SUBJ_SENTCE_SET_KEY column
*/
...
*
* @param BSubjSentceSetKey Contents of the B_SUBJ_SENTCE_SET_KEY column
*/
