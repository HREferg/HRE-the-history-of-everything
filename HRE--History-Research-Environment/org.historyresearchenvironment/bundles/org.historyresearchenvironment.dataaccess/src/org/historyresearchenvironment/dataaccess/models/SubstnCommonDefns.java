...
@Override
public SubstnCommonDefns get(int key) throws SQLException {
model = new SubstnCommonDefns();
...
*
* @param SubstnCommonDefnPid Contents of the SUBSTN_COMMON_DEFN_PID column
*/
...
*
* @param IsDataRetrieval Contents of the IS_DATA_RETRIEVAL column
*/
...
*
* @param IsValueCompare Contents of the IS_VALUE_COMPARE column
*/
