...
@Override
public MessageTemplateDefns get(int key) throws SQLException {
model = new MessageTemplateDefns();
...
*
* @param MessageTemplateDefnPid Contents of the MESSAGE_TEMPLATE_DEFN_PID column
*/
...
*
* @param RequesterPid Contents of the REQUESTER_PID column
*/
...
*
* @param SiteKey Contents of the SITE_KEY column
*/
...
*
* @param IsError Contents of the IS_ERROR column
*/
