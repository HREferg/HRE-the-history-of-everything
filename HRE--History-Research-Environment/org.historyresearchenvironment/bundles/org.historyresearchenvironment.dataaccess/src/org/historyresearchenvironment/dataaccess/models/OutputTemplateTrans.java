...
public class OutputTemplateTrans extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "OUTPUT_TEMPLATE_TRAN_PID, " + "IS_SYSTEM, " + "PLUGIN_KEY, " + "ENTITY_TYPE_KEY, " + "SUB_TYPE_KEY, "
			+ "SENTCE_STYLE_TYPE_KEY, " + "NAME_STYLE_KEY, " + "TEMPLATE_TYPE_KEY, " + "LANG_CODE, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.OUTPUT_TEMPLATE_TRANS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "OUTPUT_TEMPLATE_TRAN_PID, " + "IS_SYSTEM, " + "PLUGIN_KEY, " + "ENTITY_TYPE_KEY, "
			+ "SUB_TYPE_KEY, " + "SENTCE_STYLE_TYPE_KEY, " + "NAME_STYLE_KEY, " + "TEMPLATE_TYPE_KEY, " + "LANG_CODE, "
			+ "TEMPLATE) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.OUTPUT_TEMPLATE_TRANSSET " + "RECORD_NUM = ?, "
			+ "SET_KEY = ?, " + "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "PLUGIN_KEY = ?, " + "ENTITY_TYPE_KEY = ?, "
			+ "SUB_TYPE_KEY = ?, " + "SENTCE_STYLE_TYPE_KEY = ?, " + "NAME_STYLE_KEY = ?, " + "TEMPLATE_TYPE_KEY = ?, "
			+ "LANG_CODE = ?, " + "TEMPLATE = ? WHERE OUTPUT_TEMPLATE_TRAN_PID = ?";
	 ...
	 *
	 * @param OutputTemplateTranPid
	 *            Contents of the OUTPUT_TEMPLATE_TRAN_PID column
	 */
	 ...
	 *
	 * @param Template
	 *            Contents of the TEMPLATE column
	 */
