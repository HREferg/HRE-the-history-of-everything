...
public class SubstnSteps extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, " + "SUBSTN_STEP_PID, "
			+ "IS_SYSTEM, " + "PARENT_IS_DATA_ALIAS, " + "OWNER_TYPE_KEY, " + "OWNER_SUB_TYPE_KEY, " + "OWNER_PID, "
			+ "PARENT_STEP_PID, " + "PLAIN_TEXT, " + "NORMAL_START_STEP_PID, " + "FALSE_START_STEP_PID, "
			+ "ERROR_STEP_PID, " + "PRIOR_STEP_PID, " + "NEXT_STEP_PID, " + "IS_TEMPLATE_STEP_TYPE, "
			+ "IS_FILTER_STEP_TYPE, " + "STEP_TYPE_KEY, "
			+ "PARAM_LIST_KEY FROM PUBLIC.SUBSTN_STEPS WHERE SUBSTN_STEP_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "SUBSTN_STEP_PID, " + "IS_SYSTEM, " + "PARENT_IS_DATA_ALIAS, " + "OWNER_TYPE_KEY, "
			+ "OWNER_SUB_TYPE_KEY, " + "OWNER_PID, " + "PARENT_STEP_PID, " + "PLAIN_TEXT, " + "NORMAL_START_STEP_PID, "
			+ "FALSE_START_STEP_PID, " + "ERROR_STEP_PID, " + "PRIOR_STEP_PID, " + "NEXT_STEP_PID, "
			+ "IS_TEMPLATE_STEP_TYPE, " + "IS_FILTER_STEP_TYPE, " + "STEP_TYPE_KEY, "
			+ "PARAM_LIST_KEY FROM PUBLIC.SUBSTN_STEPS";

	private static final String INSERT = "INSERT INTO PUBLIC.SUBSTN_STEPS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "SUBSTN_STEP_PID, " + "IS_SYSTEM, " + "PARENT_IS_DATA_ALIAS, " + "OWNER_TYPE_KEY, "
			+ "OWNER_SUB_TYPE_KEY, " + "OWNER_PID, " + "PARENT_STEP_PID, " + "PLAIN_TEXT, " + "NORMAL_START_STEP_PID, "
			+ "FALSE_START_STEP_PID, " + "ERROR_STEP_PID, " + "PRIOR_STEP_PID, " + "NEXT_STEP_PID, "
			+ "IS_TEMPLATE_STEP_TYPE, " + "IS_FILTER_STEP_TYPE, " + "STEP_TYPE_KEY, " + "PARAM_LIST_KEY) VALUES (?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.SUBSTN_STEPSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "PARENT_IS_DATA_ALIAS = ?, " + "OWNER_TYPE_KEY = ?, "
			+ "OWNER_SUB_TYPE_KEY = ?, " + "OWNER_PID = ?, " + "PARENT_STEP_PID = ?, " + "PLAIN_TEXT = ?, "
			+ "NORMAL_START_STEP_PID = ?, " + "FALSE_START_STEP_PID = ?, " + "ERROR_STEP_PID = ?, "
			+ "PRIOR_STEP_PID = ?, " + "NEXT_STEP_PID = ?, " + "IS_TEMPLATE_STEP_TYPE = ?, "
			+ "IS_FILTER_STEP_TYPE = ?, " + "STEP_TYPE_KEY = ?, " + "PARAM_LIST_KEY = ? WHERE SUBSTN_STEP_PID = ?";
