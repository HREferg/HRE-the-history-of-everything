...
@Override
public PluginDefns get(int key) throws SQLException {
model = new PluginDefns();
...
*
* @param PluginDefnPid Contents of the PLUGIN_DEFN_PID column
*/
...
*
* @param ParentPckgKey Contents of the PARENT_PCKG_KEY column
*/
