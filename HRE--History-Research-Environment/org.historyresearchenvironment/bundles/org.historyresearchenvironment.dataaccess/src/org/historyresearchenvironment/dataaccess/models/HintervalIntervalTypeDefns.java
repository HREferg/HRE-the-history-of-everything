...
"SET_KEY, " +
"COMMIT_PID, " +
"HINTERVAL_INTERVAL_TYPE_DEFN_PID, " +
...
"DISPLAY_ORDER, " +  
"IS_DEFAULT, " +  
"SHOW FROM PUBLIC.HINTERVAL_INTERVAL_TYPE_DEFNS";

private static final String INSERT = "INSERT INTO PUBLIC.HINTERVAL_INTERVAL_TYPE_DEFNS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"HINTERVAL_INTERVAL_TYPE_DEFN_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.HINTERVAL_INTERVAL_TYPE_DEFNSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"ORIGINAL_CALENDAR_KEY = ?, " + 
...
@Override
public HintervalIntervalTypeDefns get(int key) throws SQLException {
model = new HintervalIntervalTypeDefns();
...
((HintervalIntervalTypeDefns) model).setHintervalIntervalTypeDefnPid(rs.getInt("HINTERVAL_INTERVAL_TYPE_DEFN_PID"));
...
*
* @param HintervalIntervalTypeDefnPid Contents of the HINTERVAL_INTERVAL_TYPE_DEFN_PID column
*/
