...
public class LabelTrans extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, " + "LABEL_TRAN_PID, "
			+ "IS_USER_DATA, " + "TABLE_KEY, " + "FIELD_KEY, " + "RECORD_PID, " + "SORT_ORDER, " + "LANG_CODE, "
			+ "ABBREV, " + "NAME, " + "DESCRIPTION, " + "STEP_PID FROM PUBLIC.LABEL_TRANS WHERE LABEL_TRAN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "LABEL_TRAN_PID, " + "IS_USER_DATA, " + "TABLE_KEY, " + "FIELD_KEY, " + "RECORD_PID, " + "SORT_ORDER, "
			+ "LANG_CODE, " + "ABBREV, " + "NAME, " + "DESCRIPTION, " + "STEP_PID FROM PUBLIC.LABEL_TRANS";

	private static final String INSERT = "INSERT INTO PUBLIC.LABEL_TRANS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "LABEL_TRAN_PID, " + "IS_USER_DATA, " + "TABLE_KEY, " + "FIELD_KEY, " + "RECORD_PID, "
			+ "SORT_ORDER, " + "LANG_CODE, " + "ABBREV, " + "NAME, " + "DESCRIPTION, " + "STEP_PID) VALUES (?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.LABEL_TRANSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_USER_DATA = ?, " + "TABLE_KEY = ?, " + "FIELD_KEY = ?, " + "RECORD_PID = ?, "
			+ "SORT_ORDER = ?, " + "LANG_CODE = ?, " + "ABBREV = ?, " + "NAME = ?, " + "DESCRIPTION = ?, "
	 ...
	 *
	 * @param FieldKey
	 *            Contents of the FIELD_KEY column
	 */
	 ...
	 *
	 * @param IsUserData
	 *            Contents of the IS_USER_DATA column
	 */
	 ...
	 *
	 * @param LabelTranPid
	 *            Contents of the LABEL_TRAN_PID column
	 */
	 ...
	 *
	 * @param SortOrder
	 *            Contents of the SORT_ORDER column
	 */
	 ...
	 *
	 * @param StepPid
	 *            Contents of the STEP_PID column
	 */
