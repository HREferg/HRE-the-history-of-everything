...
public class GuiLanguageNames extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "GUI_LANGUAGE_NAME_PID, " + "FROM_LANGUAGE, " + "TO_LANGUAGE, "
	...
	private static final String INSERT = "INSERT INTO PUBLIC.GUI_LANGUAGE_NAMES( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "GUI_LANGUAGE_NAME_PID, " + "FROM_LANGUAGE, " + "TO_LANGUAGE, "
			+ "TRANSLATION) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.GUI_LANGUAGE_NAMESSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "FROM_LANGUAGE = ?, " + "TO_LANGUAGE = ?, "
