...
private static final String INSERT = "INSERT INTO PUBLIC.DIGITAL_NAME_PARTS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"DIGITAL_NAME_PART_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.DIGITAL_NAME_PARTSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public DigitalNameParts get(int key) throws SQLException {
model = new DigitalNameParts();
...
*
* @param DigitalNamePartPid Contents of the DIGITAL_NAME_PART_PID column
*/
