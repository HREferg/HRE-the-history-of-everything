...
@Override
public FlagStateDefns get(int key) throws SQLException {
model = new FlagStateDefns();
...
*
* @param FlagStateDefnPid Contents of the FLAG_STATE_DEFN_PID column
*/
...
*
* @param ParentFlagSlot Contents of the PARENT_FLAG_SLOT column
*/
...
*
* @param StateValue Contents of the STATE_VALUE column
*/
