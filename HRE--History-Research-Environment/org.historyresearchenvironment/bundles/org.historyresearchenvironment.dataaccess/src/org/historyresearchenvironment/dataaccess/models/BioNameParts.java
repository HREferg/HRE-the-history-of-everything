...
public class BioNameParts extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "BIO_NAME_PART_PID, " + "IS_SYSTEM, " + "ELEMENT_PID, " + "THIS_NAME_EVENT_PID, "
			+ "NEXT_NAME_EVENT_PID, " + "SHARED, " + "LANG_CODE, "
			+ "TRANS FROM PUBLIC.BIO_NAME_PARTS WHERE BIO_NAME_PART_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "BIO_NAME_PART_PID, " + "IS_SYSTEM, " + "ELEMENT_PID, " + "THIS_NAME_EVENT_PID, "
			+ "NEXT_NAME_EVENT_PID, " + "SHARED, " + "LANG_CODE, " + "TRANS FROM PUBLIC.BIO_NAME_PARTS";

	private static final String INSERT = "INSERT INTO PUBLIC.BIO_NAME_PARTS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "BIO_NAME_PART_PID, " + "IS_SYSTEM, " + "ELEMENT_PID, " + "THIS_NAME_EVENT_PID, "
			+ "NEXT_NAME_EVENT_PID, " + "SHARED, " + "LANG_CODE, " + "TRANS) VALUES (?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.BIO_NAME_PARTSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "ELEMENT_PID = ?, " + "THIS_NAME_EVENT_PID = ?, "
			+ "NEXT_NAME_EVENT_PID = ?, " + "SHARED = ?, " + "LANG_CODE = ?, "
	 ...
	 *
	 * @param BioNamePartPid
	 *            Contents of the BIO_NAME_PART_PID column
	 */
