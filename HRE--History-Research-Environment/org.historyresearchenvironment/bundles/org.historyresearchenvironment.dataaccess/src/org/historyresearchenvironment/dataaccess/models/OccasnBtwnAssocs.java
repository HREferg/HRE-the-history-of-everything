...
"SET_KEY, " +
"COMMIT_PID, " +
"OCCASN_BTWN_ASSOC_PID, " +
"IS_SYSTEM, " +
"OCCASN_BTWN_ASSOC_TAG_KEY, " +
"OCCASN_SUB_TYPE_KEY, " +
"THIS_OCCASN_PID, " +
"A_ENTITY_TYPE_KEY, " +
"A_ENTITY_SUB_TYPE_KEY, " +
"A_ENTITY_PID, " +
"B_ENTITY_TYPE_KEY, " +
"B_ENTITY_SUB_TYPE_KEY, " +
"B_ENTITY_PID, " +
"THEME_KEY, " +
"SENTCE_STYLE_KEY, " +
"A_B_SENTCE_SET_PID, " +
...
private static final String INSERT = "INSERT INTO PUBLIC.OCCASN_BTWN_ASSOCS( " +
"RECORD_NUM, " +     
"SET_KEY, " +     
"COMMIT_PID, " +     
"OCCASN_BTWN_ASSOC_PID, " +     
...
private static final String UPDATE = "UPDATE PUBLIC.OCCASN_BTWN_ASSOCSSET " +
"RECORD_NUM = ?, " + 
"SET_KEY = ?, " + 
"COMMIT_PID = ?, " + 
"IS_SYSTEM = ?, " + 
...
@Override
public OccasnBtwnAssocs get(int key) throws SQLException {
model = new OccasnBtwnAssocs();
...
*
* @param OccasnBtwnAssocPid Contents of the OCCASN_BTWN_ASSOC_PID column
*/
...
*
* @param OccasnBtwnAssocTagKey Contents of the OCCASN_BTWN_ASSOC_TAG_KEY column
*/
...
*
* @param ThisOccasnPid Contents of the THIS_OCCASN_PID column
*/
...
*
* @param AEntityTypeKey Contents of the A_ENTITY_TYPE_KEY column
*/
...
*
* @param AEntitySubTypeKey Contents of the A_ENTITY_SUB_TYPE_KEY column
*/
...
*
* @param AEntityPid Contents of the A_ENTITY_PID column
*/
...
*
* @param BEntityTypeKey Contents of the B_ENTITY_TYPE_KEY column
*/
...
*
* @param BEntitySubTypeKey Contents of the B_ENTITY_SUB_TYPE_KEY column
*/
...
*
* @param BEntityPid Contents of the B_ENTITY_PID column
*/
