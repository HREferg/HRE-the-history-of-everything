...
public class GuiScreenDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "GUI_SCREEN_DEFN_PID, " + "PLUGIN_KEY, " + "TOP_ELEMENT, " + "REMINDER_KEY, " + "DISPLAY_ORDER, "
			+ "IS_DEFAULT, " + "SHOW FROM PUBLIC.GUI_SCREEN_DEFNS WHERE GUI_SCREEN_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "GUI_SCREEN_DEFN_PID, " + "PLUGIN_KEY, " + "TOP_ELEMENT, " + "REMINDER_KEY, " + "DISPLAY_ORDER, "
			+ "IS_DEFAULT, " + "SHOW FROM PUBLIC.GUI_SCREEN_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.GUI_SCREEN_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "GUI_SCREEN_DEFN_PID, " + "PLUGIN_KEY, " + "TOP_ELEMENT, " + "REMINDER_KEY, "
			+ "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.GUI_SCREEN_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "PLUGIN_KEY = ?, " + "TOP_ELEMENT = ?, " + "REMINDER_KEY = ?, "
			+ "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, " + "SHOW = ? WHERE GUI_SCREEN_DEFN_PID = ?";
	 ...
	 *
	 * @param GuiScreenDefnPid
	 *            Contents of the GUI_SCREEN_DEFN_PID column
	 */
	 ...
	 *
	 * @param TopElement
	 *            Contents of the TOP_ELEMENT column
	 */
