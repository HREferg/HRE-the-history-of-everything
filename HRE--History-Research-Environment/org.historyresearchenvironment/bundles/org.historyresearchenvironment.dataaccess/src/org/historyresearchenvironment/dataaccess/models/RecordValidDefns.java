...
public class RecordValidDefns extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "RECORD_VALID_DEFN_PID, " + "VIEW_SCRIPT_GROUP_KEY, " + "VIEW_SCRIPT_PID, " + "MODIFY_SCRIPT_GROUP_KEY, "
			+ "MODIFY_SCRIPT_PID, " + "DELETE_SCRIPT_GROUP_KEY, " + "DELETE_SCRIPT_PID, " + "REMINDER, "
			+ "DISPLAY_ORDER, " + "IS_DEFAULT, "
			+ "SHOW FROM PUBLIC.RECORD_VALID_DEFNS WHERE RECORD_VALID_DEFN_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "RECORD_VALID_DEFN_PID, " + "VIEW_SCRIPT_GROUP_KEY, " + "VIEW_SCRIPT_PID, " + "MODIFY_SCRIPT_GROUP_KEY, "
			+ "MODIFY_SCRIPT_PID, " + "DELETE_SCRIPT_GROUP_KEY, " + "DELETE_SCRIPT_PID, " + "REMINDER, "
			+ "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW FROM PUBLIC.RECORD_VALID_DEFNS";

	private static final String INSERT = "INSERT INTO PUBLIC.RECORD_VALID_DEFNS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "RECORD_VALID_DEFN_PID, " + "VIEW_SCRIPT_GROUP_KEY, " + "VIEW_SCRIPT_PID, "
			+ "MODIFY_SCRIPT_GROUP_KEY, " + "MODIFY_SCRIPT_PID, " + "DELETE_SCRIPT_GROUP_KEY, " + "DELETE_SCRIPT_PID, "
			+ "REMINDER, " + "DISPLAY_ORDER, " + "IS_DEFAULT, " + "SHOW) VALUES (?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.RECORD_VALID_DEFNSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "VIEW_SCRIPT_GROUP_KEY = ?, " + "VIEW_SCRIPT_PID = ?, "
			+ "MODIFY_SCRIPT_GROUP_KEY = ?, " + "MODIFY_SCRIPT_PID = ?, " + "DELETE_SCRIPT_GROUP_KEY = ?, "
			+ "DELETE_SCRIPT_PID = ?, " + "REMINDER = ?, " + "DISPLAY_ORDER = ?, " + "IS_DEFAULT = ?, "
