...
@Override
public CommitItems get(int key) throws SQLException {
model = new CommitItems();
...
*
* @param CommitItemPid Contents of the COMMIT_ITEM_PID column
*/
...
*
* @param ParentCmtPid Contents of the PARENT_CMT_PID column
*/
...
*
* @param PrevCmtPid Contents of the PREV_CMT_PID column
*/
