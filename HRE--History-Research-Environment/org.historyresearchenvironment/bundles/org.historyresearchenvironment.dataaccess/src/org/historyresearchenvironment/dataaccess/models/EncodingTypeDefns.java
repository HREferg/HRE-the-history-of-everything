...
@Override
public EncodingTypeDefns get(int key) throws SQLException {
model = new EncodingTypeDefns();
...
*
* @param EncodingTypeDefnPid Contents of the ENCODING_TYPE_DEFN_PID column
*/
...
*
* @param IsImportType Contents of the IS_IMPORT_TYPE column
*/
...
*
* @param IsInternalType Contents of the IS_INTERNAL_TYPE column
*/
...
*
* @param IsExportType Contents of the IS_EXPORT_TYPE column
*/
