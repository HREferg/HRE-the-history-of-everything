...
@Override
public Hdates get(int key) throws SQLException {
model = new Hdates();
...
*
* @param Hdate1 Contents of the HDATE1 column
*/
...
*
* @param Hdate2 Contents of the HDATE2 column
*/
...
*
* @param SortHdate1 Contents of the SORT_HDATE1 column
*/
...
*
* @param SortHdate2 Contents of the SORT_HDATE2 column
*/
...
*
* @param HdateTypeKey Contents of the HDATE_TYPE_KEY column
*/
