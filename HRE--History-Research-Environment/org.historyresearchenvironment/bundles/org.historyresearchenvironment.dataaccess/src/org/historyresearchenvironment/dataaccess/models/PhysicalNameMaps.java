...
public class PhysicalNameMaps extends AbstractHreDataModel {
	...
	private static final String SELECT = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PHYSICAL_NAME_MAP_PID, " + "IS_SYSTEM, " + "PARENT_NAME_PID, " + "PARENT_SUB_TYPE_KEY, "
			+ "ELEMENT_TYPE_KEY, " + "SHARED, "
			+ "INFERRED_SHARED FROM PUBLIC.PHYSICAL_NAME_MAPS WHERE PHYSICAL_NAME_MAP_PID = ?";
	private static final String SELECTALL = "SELECT " + "RECORD_NUM, " + "SET_KEY, " + "COMMIT_PID, "
			+ "PHYSICAL_NAME_MAP_PID, " + "IS_SYSTEM, " + "PARENT_NAME_PID, " + "PARENT_SUB_TYPE_KEY, "
			+ "ELEMENT_TYPE_KEY, " + "SHARED, " + "INFERRED_SHARED FROM PUBLIC.PHYSICAL_NAME_MAPS";

	private static final String INSERT = "INSERT INTO PUBLIC.PHYSICAL_NAME_MAPS( " + "RECORD_NUM, " + "SET_KEY, "
			+ "COMMIT_PID, " + "PHYSICAL_NAME_MAP_PID, " + "IS_SYSTEM, " + "PARENT_NAME_PID, " + "PARENT_SUB_TYPE_KEY, "
			+ "ELEMENT_TYPE_KEY, " + "SHARED, " + "INFERRED_SHARED) VALUES (?, " + "?, " + "?, " + "?, " + "?, " + "?, "
			+ "?, " + "?, " + "?, " + "?)";

	private static final String UPDATE = "UPDATE PUBLIC.PHYSICAL_NAME_MAPSSET " + "RECORD_NUM = ?, " + "SET_KEY = ?, "
			+ "COMMIT_PID = ?, " + "IS_SYSTEM = ?, " + "PARENT_NAME_PID = ?, " + "PARENT_SUB_TYPE_KEY = ?, "
			+ "ELEMENT_TYPE_KEY = ?, " + "SHARED = ?, " + "INFERRED_SHARED = ? WHERE PHYSICAL_NAME_MAP_PID = ?";
	 ...
	 *
	 * @param PhysicalNameMapPid
	 *            Contents of the PHYSICAL_NAME_MAP_PID column
	 */
