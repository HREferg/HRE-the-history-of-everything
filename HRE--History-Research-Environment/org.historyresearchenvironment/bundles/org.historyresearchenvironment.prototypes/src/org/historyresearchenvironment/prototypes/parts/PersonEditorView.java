 ...
 *
 */
public class PersonEditorView extends AbstractHreGuiPart {
	...
	private PersonEditorProvider provider;
	private PersonBusinessLogic businessLogic;
	private Label lblNo;
	private Text textPersonNo;

	public PersonEditorView() {
		provider = new PersonEditorProvider();
	...
	public void createControls(Composite parent) {
		...
		textBiosType.setEditable(false);
		textBiosType.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		new Label(parent, SWT.NONE);
		new Label(parent, SWT.NONE);

		lblNo = new Label(parent, SWT.NONE);
		lblNo.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblNo.setText("No.");

		textPersonNo = new Text(parent, SWT.BORDER);
		textPersonNo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		new Label(parent, SWT.NONE);
		new Label(parent, SWT.NONE);
